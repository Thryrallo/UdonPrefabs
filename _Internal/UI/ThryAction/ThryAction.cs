...
namespace Thry.Udon.UI
{
    ...
    public class ThryActionEditor : Editor
    {
        ...
        enum SpecialBehaviourType { Normal }
        ...
        void Init()
        {
            ...
            while (t != null)
            {
                if (t.GetComponent<Clapper>() != null) showClapperGUI = true;
                t = t.parent;
            }
        ...
        public static GUIStyle s_DropDownHeader()
        {
            return new GUIStyle(new GUIStyle("ShurikenModuleTitle"))
            {
        ...
        void DrawFoldout(string header, ref bool isOpen)
        {
            ...
            GUI.Box(position, new GUIContent(header), s_DropDownHeader());
