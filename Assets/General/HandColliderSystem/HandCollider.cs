...
namespace Thry.General
{
    ...
    public class HandCollider : UdonSharpBehaviour
    {
        ...
        public static HandCollider GetLeft()
        {
            ...
            return o.GetComponent<HandCollider>();
        }

        public static HandCollider GetRight()
        {
            GameObject o = GameObject.Find("[Thry]HandCollider_R");
            if (o == null)
            {
